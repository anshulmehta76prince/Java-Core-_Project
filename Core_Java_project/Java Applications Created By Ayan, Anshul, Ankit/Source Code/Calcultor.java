...
class Calculator implements ActionListener
{
    JFrame f;
    JTextField t;
    JButton b1,b2,b3,b4,b5,b6,b7,b8,b9,b0,bdiv,bmul,bsub,badd,bdec,beq,bdel,bclr,bsqrt,bsq,bpw,bfact;
    ...
    Calculator()
    {
        ...
        bsqrt.setBounds(40,300,50,40);
        bsq.setBounds(110,300,50,40);
        bpw.setBounds(180,300,50,40);
        bfact.setBounds(250,300,50,40);
        
        bdel.setBounds(60,360,60,40);
        bclr.setBounds(180,360,50,40);
